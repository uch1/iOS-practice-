...
class MyViewController : UIViewController {
    ...
    override func loadView() {
        ...
        descriptionLabel.text = "Three years ago, Apple completely revamped their design language for the modern users. It is now much simpler, allowing designer to focus on animation and function rather than intricate visual details."
